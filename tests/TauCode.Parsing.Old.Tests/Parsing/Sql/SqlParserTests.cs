...
using TauCode.Parsing.Old.Tests.Parsing.Sql.Data;
...
namespace TauCode.Parsing.Old.Tests.Parsing.Sql
{
    ...
    public class SqlParserTests
    {
        ...
        {
            // Arrange
            var nodeFactory = new OldSqlNodeFactory("my-sqlite");
...
";
            ILexer sqlLexer = new OldSqlLexer();
